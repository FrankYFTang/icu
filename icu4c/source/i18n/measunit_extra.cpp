...
void SingleUnitImpl::appendNeutralIdentifier(CharString &result, UErrorCode &status) const NO_SANITIZE_UNDEFINED {
...
MeasureUnit MeasureUnit::withPrefix(UMeasurePrefix prefix, UErrorCode& status) const NO_SANITIZE_UNDEFINED {
